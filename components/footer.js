    ...
    <>
      ...
      <footer className={ colorClasses + colorBorderClasses + `border-t w-full `}>
        <div className="flex flex-wrap items-center">
          <a href="https://www.instagram.com/reform.architecture.interiors/" target="_blank" rel="noopener noreferrer" className={ colorBorderClasses + `text-xs md:text-lg xl:text-xl uppercase font-medium block px-3 md:px-6 xl:px-8 py-4 md:py-5 xl:py-6 border-r group`}>
